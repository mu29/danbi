...
class File
  ...
  def self.iniGet(lpFileName, lpAppName, lpKeyName, lpDefault, nSize)
    ...
    GetPrivateProfileString.call(lpAppName, lpKeyName, lpDefault.to_s, buf, nSize, lpFileName)
  ...
  def self.iniWrite(lpFileName, lpAppName, lpKeyName, lpString)
    ...
    return WritePrivateProfileString.call(lpAppName, lpKeyName, lpString.to_s, lpFileName)
