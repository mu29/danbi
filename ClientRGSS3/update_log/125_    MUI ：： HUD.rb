...
module Config
  ...
  for n in 0...14
    ...
    SHORTCUT_RECT[n] = Rect.new(305 + n * 33, 512, 32, 32)
  ...
  for n in 0...14
    ...
    COOLTIME_RECT[n] = Rect.new(305 + n * 33, 511, 32, 33)
...
class MUI_HUD
  ...
  def keyUpdate
    ...
    for i in 0..14
      ...
      next if Game.slot.getSlot(i) == 99
  ...
  def cooltime
    ...
    for i in 0..14
      ...
      skill = Game.getSkill(Game.slot.getSlot(i))#.name

      cooltime = Game.cooltime.getCool(i)

      if cooltime.cooltime1.to_f <= 0

        @sprite['cool'][i].zoom_y = 0

      else

        @sprite['cool'][i].zoom_y = cooltime.cooltime1.to_f / cooltime.cooltime2.to_f

        @sprite['cool'][i].y = 34 - 33 * cooltime.cooltime1.to_f / cooltime.cooltime2.to_f
  ...
  def slotRefresh
    ...
    for n in 0..14
      ...
      @sprite[:icon][n].bitmap.blt(0, 0, RPG::Cache.icon(Game.getSkill(Game.slot.getSlot(n)).image), Rect.new(0, 0, 32, 32))
