    ...
    def menuSelected
      if (n = menuIndex)
        ...
        if Mouse.trigger?
          case n
          when 0
            MUI.include?(MUI::Form::Status)    ? MUI.getForm(MUI::Form::Status).dispose    : MUI::Form::Status.new
          when 1
            MUI.include?(MUI::Form::Skill)     ? MUI.getForm(MUI::Form::Skill).dispose     : MUI::Form::Skill.new
          when 2
            MUI.include?(MUI::Form::Inventory) ? MUI.getForm(MUI::Form::Inventory).dispose : MUI::Form::Inventory.new
          when 3
            MUI.include?(MUI::Form::Quest)     ? MUI.getForm(MUI::Form::Quest).dispose     : MUI::Form::Quest.new
          when 4
            MUI.include?(MUI::Form::Community) ? MUI.getForm(MUI::Form::Community).dispose      : MUI::Form::Community.new
          when 5
            MUI.include?(MUI::Form::Option)    ? MUI.getForm(MUI::Form::Option).dispose    : MUI::Form::Option.new
          end
        end
      else
        for n in 0..5
